    ...
    <div className="explore-meals-container">
      ...
      <section className="meals-cards">
        ...
        <div className="meal-card">
          ...
          <img src="https://plus.unsplash.com/premium_photo-1723708871094-2c02cf5f5394?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8SGVhcnR5JTIwQ2hpY2tlbiUyMFN0ZXd8ZW58MHx8MHx8fDA%3D" alt="Chicken Stew" />
          <p>
        ...
        <div className="meal-card">
          ...
          <img src="https://media.istockphoto.com/id/588595864/photo/steaming-mixed-vegetables-in-the-wok-asian-style-cooking.webp?a=1&b=1&s=612x612&w=0&k=20&c=y9JSEqRA-KbVyi7g2V9k73ZT77TUHBSWwfcqHmLTLpc=" alt="Vegetarian Stir-Fry" />
          <p>
        ...
        <div className="meal-card">
          ...
          <img src="https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8U3BpY3klMjBUaGFpJTIwQ3Vycnl8ZW58MHx8MHx8fDA%3D" alt="Thai Curry" />
          <p>
        ...
        <div className="meal-card">
          ...
          <img src="https://media.istockphoto.com/id/1045565238/photo/tasty-burger-on-a-wooden-table.webp?a=1&b=1&s=612x612&w=0&k=20&c=VOAHX2stY0k7KTIoUa7w6PciepDkkM-CESeERbKD778=" alt="Beef Burgers" />
          <p>
      ...
      <section className="details-section">
        ...
        <p>
          To elevate your cooking skills, start by mastering the basics. Knife
          skills, seasoning techniques, and understanding the timing of
          ingredients are crucial for a well-prepared dish.
        </p>
        <p>
          Don’t be afraid to experiment with flavors and adjust recipes
          according to your taste preferences. For example, adding a touch of
          citrus can brighten up any savory dish, while a sprinkle of chili
          flakes can add depth and warmth.
        </p>
        <p>
          Additionally, make sure to source fresh ingredients, as the quality of
          your food can make a significant difference in the final outcome.
          Invest in quality cookware and stay patient as you learn new recipes
          and cooking methods.
        </p>
